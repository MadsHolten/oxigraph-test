...
export declare type MainSparqlType = 'string' | 'langString' | 'dateTime' | 'boolean' | 'integer' | 'decimal' | 'float' | 'double' | 'other' | 'nonlexical';
export declare type MainNumericSparqlType = 'integer' | 'decimal' | 'float' | 'double';
