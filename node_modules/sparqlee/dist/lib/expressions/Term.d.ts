...
export declare class Literal<T extends {
    ...
    termType: 'literal';
    readonly mainSparqlType: MainSparqlType;
    /**
     ...
     */
    constructor(typedValue: T, dataType: string, strValue?: string | undefined, language?: string | undefined, mainSparqlType?: MainSparqlType);
    toRDF(): RDF.Literal;
    str(): string;
}
export declare abstract class NumericLiteral extends Literal<number> {
    ...
    strValue?: string | undefined;
    language?: string | undefined;
    readonly mainSparqlType: MainNumericSparqlType;
    constructor(typedValue: number, dataType: string, strValue?: string | undefined, language?: string | undefined, mainSparqlType?: MainNumericSparqlType);
...
export declare class DateTimeLiteral extends Literal<Date> {
    typedValue: Date;
    strValue: string;
    constructor(typedValue: Date, strValue: string, dataType?: string);
}
